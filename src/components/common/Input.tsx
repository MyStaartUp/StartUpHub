...
export const Input = forwardRef<HTMLInputElement, InputProps>(({
    ...
    return (
        <div className="space-y-1">
            <label 
                htmlFor={inputId}
                className="mb-2 block text-body-sm-medium-140 text-black">
                {label}
            ...
            <div className="relative">
                ...
                {icon && (
                    <div className="pointer-events-none text-gray-400 absolute inset-y-0 left-4 flex items-center pr-3">
                        {icon}
                    </div>
                )}
                <input
